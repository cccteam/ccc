...
const (
	// Used to remove files with the suffix "_generated.go" or prefix "generated_" instead of reading the contents of the file.
	FileName GeneratedFileDeleteMethod = iota
