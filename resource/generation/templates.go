...
{{ .Handlers }}`
	...
	typescriptTemplateHeader = `// Code generated by resourcegeneration. DO NOT EDIT.
	...
	typescriptPermissionTemplate = `{{ .Header }}
...
`
	...
	const resourceMap: ResourceMap = {
		...
		[Resources.{{ Pluralize $resource.Name }}]: {
			...
			fields: [
				{{- range $field := $resource.Fields }}
				{ fieldName: '{{ Camel $field.Name }}', dataType: '{{ Lower $field.DataType }}', required: false },
				{{- end }}
			],
		},
