...
{{ .Handlers }}`
	...
	typescriptTemplate = `// Code generated by resourcegeneration. DO NOT EDIT.
...
export function requiresPermission(resource: Resource, permission: Permission): boolean {
  return Mappings[resource][permission];
	...
	newTypescriptTemplate = `// Code generated by resourcegeneration. DO NOT EDIT.
	import { Resource } from '@cccteam/ccc-lib';
	import { ResourceMap, ResourceMeta } from '@components/Resource/resources-helpers';
	import { Resources } from './resources';
	{{- $resources := .Resources }}
	...
	const resourceMap: ResourceMap = {
		...
		[Resources.{{ $resource.Name }}]: {
			...
			fields: [
				{{- range $field := $resource.Fields }}
				{ fieldName: '{{ Camel $field.Name }}', dataType: '{{ $field.DataType }}', required: false /*todo(jrowland): what does required *mean*? */ },
				{{- end }}
			],
		},
