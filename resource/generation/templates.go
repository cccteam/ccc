...
import { {{ TypescriptConstImports .File .Data }} } from '@cccteam/ccc-lib/type';
...
import { Resource, ResourceMap, ResourceMeta{{ if .File.HasNullBoolean }}, NullBoolean{{ end }}{{ if .File.HasCustomTypesInResources }}, CustomTypes{{ end }} } from '@cccteam/ccc-lib/type';
...
import { FieldName, Method, Resource, Meta, ValidRPCTypes{{ if .File.HasCustomTypesInMethods }}, CustomTypes{{ end }} } from '@cccteam/ccc-lib/type';
