...
import { Resource, ResourceMap, ResourceMeta{{ if .File.HasNullBoolean }}, NullBoolean{{ end }}{{ if .File.HasCustomTypesInResources }}, CustomTypes{{ end }} } from '@cccteam/ccc-lib';
...
import { FieldName, Method, Resource, Meta, ValidRPCTypes{{ if .File.HasCustomTypesInMethods }}, CustomTypes{{ end }} } from '@cccteam/ccc-lib';
