...
{{- if gt (len .Domains) 0 }} 
import { Domain } from '@cccteam/ccc-lib';
{{- end }}
{{- if or (gt (len .ResourceTags) 0) (gt (len .RPCMethods) 0) }}
import { FieldName } from '@cccteam/ccc-lib';
{{- end }}
{{- if gt (len .RPCMethods) 0 }} 
import { Method } from '@cccteam/ccc-lib';
{{- end }}
{{- if gt (len .Permissions) 0 }} 
import { Permission } from '@cccteam/ccc-lib';
{{- end }}
...
import { Resources } from './{{ .GenPrefix }}_constants';
{{- if gt (len .RPCMethods) 0 }}
import { Methods } from './{{ .GenPrefix }}_constants';
{{- end }}
