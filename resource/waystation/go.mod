module github.com/cccteam/ccc/resource/waystation

go 1.26.6

replace github.com/golang-migrate/migrate/v4 v4.19.1 => github.com/jtwatson/migrate/v4 v4.19.2-beta.0

// waystation is committed in the same repo (and same commits) as the resource
...
require (
	...
	github.com/cccteam/access v0.9.12-0.20260903202458-a42a5f069600
	github.com/cccteam/ccc v0.3.4-0.20260903202555-b0ab88d06d7b
	github.com/cccteam/ccc/accesstypes v0.5.10-0.20260903202555-b0ab88d06d7b
	github.com/cccteam/ccc/resource v0.10.7-0.20260903202555-b0ab88d06d7b
