...
func (a *App) ReceiveShipment() http.HandlerFunc {
	type request struct {
		ShipmentID ccc.UUID `json:"shipmentId"`
	}

	decoder := NewRPCDecoder[rpc.ReceiveShipment, request](a, accesstypes.Execute)
