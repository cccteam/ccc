...
/** The primary key of PilotAssignments, in route order. */
export type PilotAssignmentsKey = [squadronId: string, userId: string];
...
/** The primary key of SquadronRosters, in route order. */
export type SquadronRostersKey = [squadronId: string, userId: string];
...
export const apiDescriptor: ApiDescriptor = {
  ...
  resources: {
    [Resources.Clients]: {
      ...
      patchable: ['name', 'contactName', 'contactEmail', 'trusted', 'insured'],
    },
    ...
    [Resources.MissionBoards]: {
      resource: Resources.MissionBoards,
      property: 'missionBoards',
      route: 'mission-boards',
      scope: 'domain',
      consolidated: false,
      keys: ['id'],
      operations: ['list', 'read'],
    ...
    [Resources.PilotAssignments]: {
      resource: Resources.PilotAssignments,
      property: 'pilotAssignments',
      route: 'pilot-assignments',
      scope: 'domain',
      consolidated: false,
    ...
    [Resources.SquadronRosters]: {
      resource: Resources.SquadronRosters,
  ...
  methods: {
    ...
    [Methods.HailShip]: { method: Methods.HailShip, property: 'hailShip', route: 'hail-ship', scope: 'domain', statuses: [204] },
