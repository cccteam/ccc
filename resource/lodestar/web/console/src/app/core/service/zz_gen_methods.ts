...
export interface CompileBriefingConfig {
  ...
  templateId: string | FieldPointer;
}
...
const methodMap: MethodMap = {
  ...
  [Methods.CompileBriefing]: {
    ...
    fields: [
      ...
      { fieldName: 'templateId', displayType: 'enumerated', enumeratedResource: Resources.BriefingTemplates },
    ],
  },
  ...
  [Methods.FailMission]: {
    ...
    fields: [
      { fieldName: 'missionId', displayType: 'uuid' },
      { fieldName: 'reasonId', displayType: 'enumerated', enumeration: [{ id: "aborted", display: "Aborted" }, { id: "recalled", display: "Recalled" }, { id: "solar_weather", display: "Solar weather" }, { id: "unrecoverable", display: "Unrecoverable" }] },
    ],
  },
  [Methods.HailShip]: {
    route: 'hail-ship',
