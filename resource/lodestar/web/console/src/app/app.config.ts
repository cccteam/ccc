...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // The generated API client for the crew console: one typed surface over every
    // default-outlet route, one permission cache for the app's pages and the
    // library's guard, directive, and forms. The transport rides HttpClient so the
    // interceptor keeps applying.
