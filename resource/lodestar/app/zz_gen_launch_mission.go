...
func (a *App) LaunchMission() http.HandlerFunc {
	type request struct {
	...
	decoder := NewTargetedRPCDecoder[rpc.LaunchMission, request](a, accesstypes.Execute)
	...
	return httpio.Log(func(w http.ResponseWriter, r *http.Request) error {
		...
		if err := a.ResourceClient().ExecuteFunc(ctx, func(ctx context.Context, txn resource.ReadWriteTransaction) error {
			...
			default:
				...
				return httpio.NewForbiddenMessagef("LaunchMission may not run against Mission %s", p.MissionID)
			}
