	...
	return resource.MustNewGeneratedCollection(resource.CollectionData{
		Resources: []resource.CollectionResource{
			...
			},
			{
				...
				Permissions: []accesstypes.Permission{accesstypes.List},
				Tags: []resource.TagData{
					{Name: "clientName", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "daysLeft", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "deadline", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "id"},
					{Name: "kindId", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "sectorId", Permissions: []accesstypes.Permission{accesstypes.List}},
			...
			},
			{
				...
				Permissions: []accesstypes.Permission{accesstypes.List},
				Tags: []resource.TagData{
					{Name: "pilotId", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "pilotName", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "sectorId", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "squadronId"},
					{Name: "squadronName", Permissions: []accesstypes.Permission{accesstypes.List}},
					{Name: "userId"},
