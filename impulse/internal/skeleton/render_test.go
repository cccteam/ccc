...
func TestRender(t *testing.T) {
	...
	static := []string{"generator-program", "options", "tenancy-wired", "outlet-wired", "emulator-version", "prettier-ignore", "eslint-ignore", "package-manager", "multi-site", "env-template"}
