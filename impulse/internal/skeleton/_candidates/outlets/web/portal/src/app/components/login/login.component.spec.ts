...
describe('LoginComponent', () => {
  ...
  it('offers the directory sign-in and says nothing while no refusal code is in the URL', () => {
    const element: HTMLElement = fixture.nativeElement;
    expect(element.querySelector('button')?.textContent).toContain('Sign in with your organization');
