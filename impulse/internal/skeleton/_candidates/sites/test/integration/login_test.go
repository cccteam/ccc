...
// TestLogin drives the console site the way its browser application does: sign in,
// read the session, read the tenant list and a tenant's permission digest, and probe a
// tenant the login holds nothing in.
