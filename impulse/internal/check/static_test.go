...
func TestFixes(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "resource-styles prepends the import",
			check:       resourceStyles{},
			wantSummary: "1 stylesheet(s) updated",
			wantFile:    "web/console/src/styles.scss",
			wantContent: "// The @cccteam/resource-angular components' cross-cutting classes and variables.\n@use '@cccteam/resource-angular/styles';\n\nhtml,\nbody {\n  margin: 0;\n}\n",
		},
		{
