module github.com/cccteam/ccc/columnset

go 1.23.1

require (
	github.com/cccteam/ccc/accesstypes v0.5.0
	github.com/cccteam/ccc/resourceset v0.4.1
...
require (
	...
	github.com/cccteam/ccc v0.2.9 // indirect
	github.com/cccteam/ccc/patchset v0.3.0 // indirect
